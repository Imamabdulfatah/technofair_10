    ...
    <section class="pb-20  bg-gray-300 dark:bg-slate-800">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="w-full md:w-4/12 px-4 mt-8 mr-auto ml-auto">
                ...
                <img alt="Capture The Flag" src="{{ $image }}" class="w-full align-middle rounded-t-lg"/>
                <blockquote class="relative p-8 mb-4">
                    ...
                    ></polygon>
                        ...
                        <h4 class="text-xl font-bold text-white">Contact Person :</h4>
                            ...
                            <i class="flex fab fa-whatsapp"><span class="mx-2">089669250683 |Chintia via WhatsApp  </span></i>
                            </p>
                            <p class="text-md font-light mt-2 text-white">
                                <i class="flex fab fa-line"><span class="mx-2">089669250683 |Chintia via Line</span>  </i> 
                            </p>
                            <h4 class="text-xl font-bold text-white mt-3">Contact Person 2 :</h4>
                            <p class="text-md font-light mt-2 text-white">
                            <i class="flex fab fa-whatsapp"><span class="mx-2"> 082346946076 | Zulfaidahvia WhatsApp  </span></i>
                            </p>
                            <p class="text-md font-light mt-2 text-white">
                                <i class="flex fab fa-line"><span class="mx-2"> 082346946076| Zulfaidah via Line</span>  </i> 
                            </p>
                </blockquote>
                <div class="container flex  mx-auto">
                    ...
                    <div class="mx-auto">
                        @if ($oc->status === "open")
                            ...
                            @else  
                            <a type="button" class="text-white bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-lg text-xl px-5 py-3 text-center mb-12" href="/registration/competition">Daftar</a>
                            @endauth
                        @else
                    ...
                    <div class="mx-auto {{ ($oc->status === "open") ? '' : 'd-none' }}">
                         <a href="/pdf/RULEBOOK-CAPTURE-THE-FLAG-TF.pdf" download="RULE BOOK CAPTURE THE FLAG TF" class="flex text-white  bg-gradient-to-r from-purple-500 via-purple-600 to-purple-700 hover:bg-gradient-to-br focus:ring-4 focus:outline-none focus:ring-purple-300 dark:focus:ring-purple-800 font-medium rounded-lg text-xl px-4 py-3 text-center "><img src="https://img.icons8.com/ios/25/null/downloads.png" width="30" height="20"/>Rule Book</a>
                    </div>
                    @endforeach
        ...
        <section class="relative py-20">
            ...
            <div class="flex w-full flex-wrap justify-evenly px-2 xl:mx-auto mb-10 xl:w-10/12">  
                <div class="w-80 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">09.00 - selesai | 8 Juli 2023</p>
                </div>
                ...
                <div class="w-80 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">Zoom Clouds Meetings & Discord</p>
                </div>   
                <div class="w-80 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">Rp. 80.000/Tim</p>
                </div>
            </div>
        </div>
    </section>
    ...
    <div class="w-10/12 md:w-7/12 lg:6/12 mx-auto relative py-20">
        ...
        <div class="border-l-2 mt-10">
            ...
            <div class="transform transition cursor-pointer hover:-translate-y-2 ml-10 relative flex items-center px-6 py-4 bg-yellow-600 text-white rounded mb-10 flex-col md:flex-row space-y-4 md:space-y-0">
                ...
                <div class="flex-auto">
                  <h1 class="text-lg">29 Mei - 30 Juni 2023</h1>
              ...
              <div class="transform transition cursor-pointer hover:-translate-y-2 ml-10 relative flex items-center px-6 py-4 bg-green-600 text-white rounded mb-10 flex-col md:flex-row space-y-4 md:space-y-0">
                ...
                <div class="flex-auto">
                  <h1 class="text-lg">9 Juli 2023</h1>
              ...
              <div class="transform transition cursor-pointer hover:-translate-y-2 ml-10 relative flex items-center px-6 py-4 bg-purple-600 text-white rounded mb-10 flex-col md:flex-row space-y-4 md:space-y-0">
               ...
               <div class="transform transition cursor-pointer hover:-translate-y-2 ml-10 relative flex items-center px-6 py-4 bg-teal-600 text-white rounded mb-10 flex-col md:flex-row space-y-4 md:space-y-0">
                ...
                <div class="flex-auto">
                  <h1 class="text-lg">
                    22 Juli 2023</h1>
                  <h1 class="text-xl font-bold">Pembagian Hadiah</h1>
                </div>
              </div>
        </div>
    </div>
            ...
            <div id="accordion-color" data-accordion="collapse" data-active-classes="bg-blue-100 dark:bg-gray-800 text-blue-600 dark:text-white">
                ...
                <div id="accordion-color-body-4" class="hidden" aria-labelledby="accordion-color-heading-4">
                 ...
                 <h2 id="accordion-color-heading-15">
                    <button type="button" class="flex items-center justify-between w-full p-5 font-bold text-left text-gray-900 border border-gray-200 focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-800 dark:border-gray-700 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-gray-800" data-accordion-target="#accordion-color-body-15" aria-expanded="false" aria-controls="accordion-color-body-15">
                ...
                <h2 id="accordion-color-heading-16">
                    <button type="button" class="flex items-center justify-between w-full p-5 font-bold text-left text-gray-900 border border-gray-200 focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-800 dark:border-gray-700 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-gray-800" data-accordion-target="#accordion-color-body-16" aria-expanded="false" aria-controls="accordion-color-body-16">
                ...
                <h2 id="accordion-color-heading-17">
                    <button type="button" class="flex items-center justify-between w-full p-5 font-bold text-left text-gray-900 border border-gray-200 focus:ring-4 focus:ring-blue-200 dark:focus:ring-blue-800 dark:border-gray-700 dark:text-gray-400 hover:bg-blue-100 dark:hover:bg-gray-800" data-accordion-target="#accordion-color-body-17" aria-expanded="false" aria-controls="accordion-color-body-17">
