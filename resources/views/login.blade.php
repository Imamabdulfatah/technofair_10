...
@section('container')
<section class="bg-white mt-48 dark:bg-gray-900">
    <div class="container px-6 py-24 mx-auto lg:py-32">
        <div class="lg:flex">
            <div class="lg:w-1/2">
                <img class="w-20 h-20 " src="/img/logo/logo.png" alt="">
            ...
            <div class="mt-8 lg:w-1/2 lg:mt-0">
                <form class="w-full lg:max-w-xl">
                    ...
                    <div class="mt-8 md:flex md:items-center">
                        ...
                        <a href="/register" class="inline-block mt-4 text-center text-blue-500 md:mt-0 md:mx-6 hover:underline dark:text-blue-400">
                            Are you register ?
                        </a>
                    </div>
                </form>
