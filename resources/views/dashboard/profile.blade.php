...
@section('container')
<div class="ease-soft-in-out xl:ml-68.5 mr-72 relative h-full max-h-screen bg-gray-50 transition-all duration-200">
    ...
    <div class="flex items-center justify-between w-full px-6 py-1 mx-auto flex-wrap-inherit">
      <nav>
        ...
        <ol class="flex flex-wrap pt-1 pl-2 pr-4 mr-12 bg-transparent rounded-lg sm:mr-16">
          ...
          <li class="text-sm pl-2 capitalize leading-normal before:float-left before:pr-2 before:content-['/']" aria-current="page">{{ $title }}</li>
        </ol>
        <h6 class="mb-2 ml-2 font-bold text-white capitalize">{{ $title }}</h6>
      </nav>
