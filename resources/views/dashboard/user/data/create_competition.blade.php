        ...
        <div class="modal-content">
          <div class="modal-body">
            ...
            <div class="mb-3 col-lg-6 col-md-6 col-sm-12">
              ...
              <textarea class="form-control @error('anggota') is-invalid @enderror" placeholder="Imam Abdul(2KB02 | 20121592)" id="anggota" style="height: 100px" required value="{{ old('anggota') }}" name="anggota"></textarea>
              @error('anggota')
              <div class="invalid-feedback">
                {{ $message }}
              </div>
