        ...
        <div class="container mx-auto px-4">
            ...
            <div class="w-full md:w-5/12 px-4 mr-auto ml-auto">
                ...
                <i class="fas fa-user-friends text-xl"></i>
                    ...
                    >
                    Webinar ini akan mengangkat topik big data. Big data adalah kumpulan data yang sangat besar, kompleks dan terus bertambah setiap waktu. 
                    </p>
                    <p
                    class="text-lg font-light leading-relaxed mt-0 mb-4 text-gray-700"
                    >
                    Data ini dihasilkan dari aktivitas internet yang makin rutin dilakukan, baik untuk tujuan pribadi maupun bisnis. Webinar ini bermaksud memperkenalkan big data yang merupakan bagian dari dunia teknologi yang sedang trend saat ini dan mengimplementasikan big data kepada para peserta.
                    </p>
            ...
            <div class="w-full md:w-4/12 px-4 mr-auto ml-auto">
                ...
                <img
                    alt="big data"
                    src="/img/asset/webinar/big-data2.jpg"
