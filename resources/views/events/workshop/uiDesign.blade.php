        ...
        <div class="container mx-auto px-4">
            ...
            <div class="w-full md:w-5/12 px-4 mr-auto ml-auto">
                ...
                <i class="fas fa-user-friends text-xl"></i>
                    ...
                    >
                    Webinar ini akan mengangkat topik smart city. Smart city adalah sebuah konsep kota yang memanfaatkan teknologi informasi untuk mengintegrasikan seluruh infrastruktur dan pelayanan dari pemerintah kepada warga masyarakat. 
                    </p>
                    <p
                    class="text-lg font-light leading-relaxed mt-0 mb-4 text-gray-700"
                    >
                    Workshop yang mengambil tema “Exploring UI Design Using Figma” ini akan mengangkat topik mengenai UI Design. User Interface (UI) Design atau desain antarmuka adalah proses yang digunakan desainer untuk membuat tampilan dalam perangkat lunak atau perangkat terkomputerisasi, dengan fokus pada tampilan atau gaya. Workshop ini memberikan pelatihan dan pembekalan kepada peserta mengenai penggunaan Figma dalam pembuatan UI Design.
                    </p>
            ...
            <div class="w-full md:w-4/12 px-4 mr-auto ml-auto">
                ...
                <img
                    alt="..."
                    src="/img/asset/workshop/ui-design2.png"
        ...
        <section class="relative py-20">
            ...
            <div class="flex w-full flex-wrap justify-evenly px-2 xl:mx-auto mb-10 xl:w-10/12">  
                ...
                <div class="w-80 p-6 bg-white border border-gray-200 rounded-lg shadow dark:bg-gray-800 dark:border-gray-700">
                    ...
                    <p class="mb-3 font-normal text-gray-500 dark:text-gray-400">Rp. 20.000</p>
