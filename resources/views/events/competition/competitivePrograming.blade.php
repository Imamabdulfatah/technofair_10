    ...
    <section class="pb-20 bg-gray-300 -mt-28 sm:-mt-40 dark:bg-slate-800">
        ...
        <div class="container mx-auto px-4">
            ...
            <div class="w-full md:w-4/12 px-4 mt-8 mr-auto ml-auto">
                ...
                <img
                    alt="..."
                    src="/img/asset/competition/infografic2.jpg"
        ...
        <div class="container mx-auto -mt-24 sm:-mt-12 -mb-20 px-4 lg:pt-24 lg:pb-64 md:pb-54 sm:pb-32">
            ...
            <div id="accordion-color" data-accordion="collapse" data-active-classes="bg-blue-100 dark:bg-gray-800 text-blue-600 dark:text-white">
                ...
                <div id="accordion-color-body-4" class="hidden" aria-labelledby="accordion-color-heading-4">
                    <div class="p-5 font-light border border-t-0 border-gray-200 dark:border-gray-700">
                        <p class="mb-2 text-gray-200 dark:text-gray-400">Pada kompetisi ini terdapat 2 babak, babak penyisihan berupa penilaian oleh para juri melalui beberapa aspek/poin penilaian yang sudah ditentukan dan babak e-voting berupa penilaian audiens | like, view, share | dari poster yang akan diunggah di Instagram TechnoFair 9.0 | @technofair. |</p>
                ...
                <div id="accordion-color-body-8" class="hidden" aria-labelledby="accordion-color-heading-10">
                    <div class="p-5 font-light border border-t-0 border-gray-200 dark:border-gray-700">
                        <p class="mb-2 text-gray-200 dark:text-gray-400">Template narasi singkat, lembar orisinalitas, dan logo dapat diunduh pada website TechnoFair 9.0 (www.technofair.id).</p>
                ...
                <div id="accordion-color-body-9" class="hidden" aria-labelledby="accordion-color-heading-7">
                    <div class="p-5 font-light border border-t-0 border-gray-200 dark:border-gray-700">
                        <p class="mb-2 text-gray-200 dark:text-gray-400">Kompetisi ini dikhususkan untuk Siswa SMA/Sederajat dan mahasiswa yang masih aktif. Namun, tidak ada perbedaan kategori SMA/SMK dan mahasiswa.</p>
                ...
                <div id="accordion-color-body-10" class="hidden" aria-labelledby="accordion-color-heading-8">
                    <div class="p-5 font-light border  border-t-0 border-gray-200 dark:border-gray-700">
                        <p class="mb-2 text-gray-200 dark:text-gray-400">Boleh, dengan ketentuan peserta berasal dari universitas/instansi terkait yang sama.</p>
