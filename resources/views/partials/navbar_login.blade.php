      ...
      <div class="flex items-center px-3">
        ...
        >
          <ul class="block lg:flex">
            <li class="group">
              <a href="/" class="group-hover:text- mx-8 flex py-2 text-2xl text-primary">Beranda</a>
            </li>
            ...
            <li class="group">
              <a href="#portfolio" class="group-hover:text- mx-8 flex py-2 text-2xl text-primary">Schedule</a>
            </li>
           
            <li class="group">
              <a href="#contact" class="group-hover:text mx-8 flex py-2 text-2xl text-primary">Contact</a>
            </li> --}}
